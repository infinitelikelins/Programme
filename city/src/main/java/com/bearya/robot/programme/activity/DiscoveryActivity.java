...
import com.bearya.robot.programme.adapter.DevicesAdapter;
...
public class DiscoveryActivity extends BaseActivity implements View.OnClickListener {
    ...
    private void castingSwitch() {
        ...
        if (defaultAdapter.isEnabled()) {
            Toast.makeText(this, getString(R.string.bluetooth_closing), Toast.LENGTH_SHORT).show();
            castingSettings.setText(getString(R.string.bluetooth));
            defaultAdapter.disable();
            toCasting.setEnabled(false);
        } else {
            Toast.makeText(this, getString(R.string.bluetooth_opening), Toast.LENGTH_SHORT).show();
