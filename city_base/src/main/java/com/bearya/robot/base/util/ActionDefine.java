...
public class ActionDefine {
     ...
     * 显示表情
     */
    public static void showEmotion(Context context, int emotionId) {
        sendMessagerToServices(context, new Messager(Messager.SHOW_EMOTION, Messager.VALUE, emotionId));
    }
    ...
    public static void sendMessagerToClients(Context context, Messager msg) {
        sendMessagerWithAction(context, Messager.ACTION_TALKYPEN_FROM_SERVICE, msg);
    }
